...
const GenerateThumbnail = (
  ...
  //**Here in Handle function we store image either it is generated image or uploaded image
  //** and the access that image upto our requirement

  const handleImage = async (blob: Blob, fileName: string) => {

    setIsImageLoading(true);
    //**Reseting the image, just in case it's set before
    setImage('');
    //TODO:
    try {
  ...
  const uploadImage = async (e: React.ChangeEvent<HTMLInputElement>) => {
    e.preventDefault(); //! Not to reload the page after we upload image
  ...
  return (
    <>
      <div className='generate_thumbnail'>
        //** variant plain was doesn't exists so there is need to modify shadcn components
